...
<tbody>
<tr class="odd">
<td align="left"><p>If the code must create the **Orient</span> property, it must also create the value to store in the property, as a new <span sdata="cer" target="T:DocumentFormat.OpenXml.EnumValue`1"><span class="nolink">EnumValue&lt;T&gt;</span></span> instance, supplying the new orientation in the <span class="keyword">EnumValue** constructor.</p></td>
</tr>
</tbody>
</table>
