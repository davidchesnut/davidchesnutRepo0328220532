...
<td align="left"><p>Comment's text content.</p></td>
</tr>
<tr class="even">
...
<tbody>
<tr class="odd">
<td align="left"><p>To get the exact author's name, open the presentation file and click the <strong>File</strong> menu item, and then click <strong>Options</strong>. The <strong>PowerPoint Options</strong> window opens and the content of the <strong>General</strong> tab is displayed. The author's name must match the <strong>User name</strong> in this tab.</p></td>
</tr>
</tbody>
</table>
