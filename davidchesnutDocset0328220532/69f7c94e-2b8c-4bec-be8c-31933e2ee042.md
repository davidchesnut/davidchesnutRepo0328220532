...
<tbody>
<tr class="odd">
<td align="left"><p>Some text</p></td>
<td align="left"><p>Some text</p></td>
<td align="left"><p>Some text</p></td>
</tr>
<tr class="even">
<td align="left"><p>Some text</p></td>
<td align="left"><p>Some text</p></td>
<td align="left"><p>The text from the API example</p></td>
</tr>
</tbody>
</table>
...
[How to: Change Text in a Table in a Word Processing
Document](http://msdn.microsoft.com/en-us/library/documentformat.openxml.wordprocessing.table(office.14).aspx)
